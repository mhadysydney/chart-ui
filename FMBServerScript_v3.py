...
LOG_FILE = 'serverLog_v3.log'
DB_FILE = 'teltonika_data_v3.db'
...
def handle_client(conn, addr):
    ...
    # Step 4: Parse AVL data and get the number of records
    num_records = parse_avl_data(avl_data, imei)

    # Step 5: Send acknowledgment (4 bytes: number of records)
